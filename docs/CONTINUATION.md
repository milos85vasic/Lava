...
> **Last updated:** 2026-06-02 (LVA on-device-API session — HANDOFF to a fresh session for the remaining big programs; operator chose fresh-session for context room).
>
