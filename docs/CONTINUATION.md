...
> **Last updated:** 2026-06-12 (**🔎 CRASHLYTICS AUDIT + Defect-A fix + Defect-B phase-1 (2 embedded curated providers)**). Operator: "Check Crashlytics for both apps" + "only 4 providers in onboarding — investigate, fix, test" + "On device api app MUST have Jackett embedded same we have the API itself".
>
