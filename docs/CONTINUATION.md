...
> - **Ledger state:** Queued: LVA-6 codegraph-index, LVA-008 C11 (DEFERRED operator-gated). Fixed/Completed: LVA-009..019 + LVA-7 (14 closed). LVA-5 operator-blocked (§6.H Firebase token rotation). LVA-3/LVA-4 in-progress. 19 items, CM-WORKABLE-ITEMS-SYNC OK.
>
