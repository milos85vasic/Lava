...
<redacted — RuTracker creds live only in gitignored .env per §6.H>
<redacted — RuTor creds live only in gitignored .env per §6.H>
<redacted — IPTorrents creds live only in gitignored .env per §6.H>
<redacted — NNMClub creds live only in gitignored .env per §6.H>
