...
This privacy policy applies to the Lava app (hereby referred to as "Application") for mobile
devices that was created by Milos Vasic (hereby referred to as "Service Provider") as an
...
account for rutracker.org. The information that the Service Provider request will be retained by
...
provided via the Application, please contact them at [vasicdigital@mail.ru](mailto:vasicdigital@mail.ru)
...
information, please contact the Service Provider ([vasicdigital@mail.ru](mailto:vasicdigital@mail.ru))
...
[vasicdigital@mail.ru](mailto:vasicdigital@mail.ru).
