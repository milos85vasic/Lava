...
func (a *ProviderAdapter) DisplayName() string { return "Torrents-CSV" }

// AuthType returns NONE — Torrents-CSV search is anonymous.
...
// Capabilities: Torrents-CSV yields search rows with magnet links (no .torrent
...
// Browse is unsupported (Torrents-CSV has no category-browse endpoint).
...
// GetTorrent is unsupported — Torrents-CSV serves magnet links, not .torrent files.
...
// HealthCheck probes Torrents-CSV with a fixed query.
