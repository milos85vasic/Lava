...
// test for the single-attempt gap: Knaben's variable live latency / meta-fanout
...
//
//	Mutation: replace the c.fetchHits call in Search with a direct
//	          c.fetchHitsOnce call (drop the retry loop), restoring the
//	          single-attempt behavior.
//	Observed: "Search after transient 503 should recover via retry:
//	          knaben: HTTP 503: provider: unknown error".
//	Reverted: yes.
