...
func (a *ProviderAdapter) DisplayName() string { return "The Pirate Bay" }

// AuthType returns NONE — The Pirate Bay search is anonymous.
...
// Capabilities: apibay yields search rows with magnet links (no .torrent files),
...
// Browse is unsupported (apibay has no category-browse endpoint).
...
// GetTorrent is unsupported — apibay serves magnet links, not .torrent files.
...
// HealthCheck probes apibay with a fixed query.
