...
func ___syscall_cp(tls *TLS, n, a, b, c, d, e, f long) long {
	if r, ok := remapLegacyPathSyscall(n, a, b, c); ok { // Lava F3: Android x86_64 seccomp legacy-syscall remap
		return r
	}
...
func X__syscall1(tls *TLS, n, a1 long) long {
	if r, ok := remapLegacyPathSyscall(n, a1, 0, 0); ok { // Lava F3: Android x86_64 seccomp legacy-syscall remap
		return r
	}
...
func X__syscall2(tls *TLS, n, a1, a2 long) long {
	if r, ok := remapLegacyPathSyscall(n, a1, a2, 0); ok { // Lava F3: Android x86_64 seccomp legacy-syscall remap
		return r
	}
...
func X__syscall3(tls *TLS, n, a1, a2, a3 long) long {
	if r, ok := remapLegacyPathSyscall(n, a1, a2, a3); ok { // Lava F3: Android x86_64 seccomp legacy-syscall remap
		return r
	}
