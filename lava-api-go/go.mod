...
replace (
	...
	// HelixQA depends on these local vasic-digital modules; without replace
	// directives lava-api-go fails to resolve them from the network.
...
replace modernc.org/libc => ./third_party/modernc-libc
