...
> Inherits Laws 1–6 from the root Anti-Bluff Testing Pact in `/CLAUDE.md`. The Sixth Law (Real User Verification) is binding on every core module — submodule rules below are additive, never relaxing.
