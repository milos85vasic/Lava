...
object LavaIcons {
    ...
    val ThemeYole: Icon = Icon.ImageVectorIcon(MaterialIcons.WaterDrop)
    val ThemeDracula: Icon = Icon.ImageVectorIcon(MaterialIcons.FilterVintage)
    val ThemeSolarized: Icon = Icon.ImageVectorIcon(MaterialIcons.WbTwilight)
    val ThemeNord: Icon = Icon.ImageVectorIcon(MaterialIcons.WaterDrop)
    val ThemeMonokai: Icon = Icon.ImageVectorIcon(MaterialIcons.FavoriteBorder)
    val ThemeGruvbox: Icon = Icon.ImageVectorIcon(MaterialIcons.Forest)
    val ThemeOneDark: Icon = Icon.ImageVectorIcon(MaterialIcons.DarkMode)
    val ThemeTokyoNight: Icon = Icon.ImageVectorIcon(MaterialIcons.LightMode)
