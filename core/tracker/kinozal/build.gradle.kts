...
tasks.register<Test>("integrationTest") {
    description = "Real-tracker integration tests against kinozal.tv. Operator-driven."
    group = "verification"
...
// JVM as a system property so KinozalRealNetworkDownloadTest can read it via
...
// the gitignored `.env` (KINOZAL_USERNAME/PASSWORD) reach System.getenv when the
