...
private val Color.textColor: ColorValue
    get() = when (val color = this.color) {
        is lava.network.dto.topic.ColorValue.Hex -> ColorValue.Hex(color.hex)
        is lava.network.dto.topic.ColorValue.Name -> ColorValue.Name(color.name)
    }

private val Align.textAlignment: TextAlignment
    get() = when (alignment) {
        lava.network.dto.topic.TextAlignment.Left -> TextAlignment.Left
        lava.network.dto.topic.TextAlignment.Right -> TextAlignment.Right
        lava.network.dto.topic.TextAlignment.Center -> TextAlignment.Center
        lava.network.dto.topic.TextAlignment.Justify -> TextAlignment.Justify
    }
