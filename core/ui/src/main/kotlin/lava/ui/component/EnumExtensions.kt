...
val TorrentStatus.icon: Icon
    get() = when (this) {
        TorrentStatus.DUPLICATE -> LavaIcons.TorrentStatus.Duplicate
        TorrentStatus.NOT_APPROVED -> LavaIcons.TorrentStatus.Checking
        TorrentStatus.CHECKING -> LavaIcons.TorrentStatus.Checking
        TorrentStatus.APPROVED -> LavaIcons.TorrentStatus.Approved
        TorrentStatus.NEEDS_EDIT -> LavaIcons.TorrentStatus.NeedsEdit
        TorrentStatus.CLOSED -> LavaIcons.TorrentStatus.Closed
        TorrentStatus.NO_DESCRIPTION -> LavaIcons.TorrentStatus.NoDescription
        TorrentStatus.CONSUMED -> LavaIcons.TorrentStatus.Consumed
    }
