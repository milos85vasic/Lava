...
import lava.designsystem.theme.isMaterialYouAvailable
import lava.menu.MenuAction.AboutClick
import lava.menu.MenuAction.ClearBookmarksConfirmation
...
import lava.ui.component.ModalBottomDialog
import lava.ui.component.VisibilityState
    ...
    LazyList(
        ...
        menuSelectionItem(
            ...
            iconMapper = { theme ->
                Icon(
                    icon = when (theme) {
                        Theme.SYSTEM -> LavaIcons.ThemeSystem
        ...
        onSelect = { syncPeriod ->
            ...
            if (syncPeriod != SyncPeriod.OFF) {
                if (permission.status.shouldShowRationale) {
                    confirmationDialogState.show(
                        icon = LavaIcons.Notifications,
                        R.string.permission_show_notifications_rationale_title,
                        R.string.permission_show_notifications_rationale,
                        lava.designsystem.R.string.designsystem_action_ok,
                        lava.designsystem.R.string.designsystem_action_cancel,
                ...
                Row(
                    ...
                    Icon(
                        icon = if (isSelected) {
                            ...
                            LavaIcons.NotSelected
                        },
                        tint = AppTheme.colors.onSurface,
                        contentDescription = stringResource(
                            if (isSelected) {
                                lava.connection.R.string.content_description_endpoint_selected
                            } else {
                                lava.connection.R.string.content_description_endpoint_not_selected
                            },
                        ),
                    )
                    BodyLarge(
