...
private fun AuthorDialog(
    ...
    if (state.visible) {
        ...
        Dialog(
            icon = { Icon(icon = LavaIcons.Author, contentDescription = null) },
            ...
            confirmButton = {
                TextButton(
                    text = stringResource(lava.designsystem.R.string.designsystem_action_apply),
                    onClick = ::onSubmit,
                )
            },
            dismissButton = {
                ...
                if (author != null) {
                    TextButton(
                        text = stringResource(lava.designsystem.R.string.designsystem_action_reset),
                        onClick = ::onReset,
                    )
                }
            },
