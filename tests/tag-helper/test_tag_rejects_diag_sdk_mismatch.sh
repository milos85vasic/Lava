...
# (Group B clause 6.I Gate 3 — the AVD-shadow bluff)
set -u
...
cat > "$PACK/matrix/run1/real-device-verification.json" <<'EOF'
{
  ...
  "rows": [
    ...
    {"avd":"CZ_API34_Phone","api_level":34,"form_factor":"phone","test_class":"lava.app.X","test_passed":true,"diag":{"sdk":33,"device":"Pixel"},"failure_summaries":[],"concurrent":1},
